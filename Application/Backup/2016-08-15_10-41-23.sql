...
insert into `wp_accountinfo`(`aid`,`uid`,`balance`,`frozen`,`pwd`) values('1','67','10000919166.20','','');
...
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('370','67','9','0','1471064577','1','0','0','31875.00','0.00','0','0','0.6','0','1471064577495','阿胶块','10000919252.2','0.0','0');
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('371','67','5','0','1471105091','1','0','0','4328.00','0.00','0','0','6.0','0','1471105091515','1000g银砖','10000919166.2','0.0','0');
...
insert into `wp_productinfo`(`pid`,`ptitle`,`cid`,`uprice`,`feeprice`,`wave`,`company`,`patx`,`patj`) values('9','1111','3','20000000000','0.6','5','0.5g','0','0');
