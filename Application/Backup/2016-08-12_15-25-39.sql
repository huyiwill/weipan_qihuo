...
insert into `wp_accountinfo`(`aid`,`uid`,`balance`,`frozen`,`pwd`) values('1','67','10000919172.00','','');
...
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('368','67','9','1','1470911980','1','0','0','31875.00','0.00','20','20','0.6','0','1470911980995','0.1t铜2222','10000919130.0','0.0','0');
...
insert into `wp_productinfo`(`pid`,`ptitle`,`cid`,`uprice`,`feeprice`,`wave`,`company`,`patx`,`patj`) values('8','1t铜','3','40000','6','2','1t','0','0');
