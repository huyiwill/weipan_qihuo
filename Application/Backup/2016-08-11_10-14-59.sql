...
insert into `wp_accountinfo`(`aid`,`uid`,`balance`,`frozen`,`pwd`) values('1','67','10000919230.60','','');
...
insert into `wp_order`(`oid`,`uid`,`pid`,`ostyle`,`buytime`,`onumber`,`selltime`,`ostaus`,`buyprice`,`sellprice`,`endprofit`,`endloss`,`fee`,`eid`,`orderno`,`ptitle`,`commission`,`ploss`,`display`) values('366','67','2','0','1470622908','1','0','0','0.00','0.00','0','10','0.6','0','1470622908995','0.1t油','10000919156.6','0.0','0');
