    ...
    <div class="container-fluid">
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
            	<form action="<?php echo U('Goods/gtypeadd');?>" method="post">
                <!-- left column -->
                <div class="span8 column">
					<div class="field-box">
						<label>分类名称：</label>
						<input class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入商品名称" data-placement="right" name="cname"/>
					</div>
