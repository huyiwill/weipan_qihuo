...
<body>
    ...
    <div class="container-fluid">
        <div id="pad-wrapper" class="users-list">
           <form action="<?php echo U('Order/zxlist');?>" method="post">
            <div class="row-fluid header">
                <h3>订单列表</h3>
                <div class="span10 pull-right" style="margin-top: 20px;">
                    <div class="tpsearch">
                    	商品分类：<select id="ostyle" class="span6" name="ostyle">
                    ...
                    <div class="tpsearch">
                    	交易金额：<select id="ploss" class="span6" name="ploss">
                    				<option value="">默认不选</option>
	                                <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['uprice']); ?>"><?php echo ($vo['uprice']); ?>元</option><?php endforeach; endif; else: echo "" ;endif; ?>
                    			</select>
                    </div>
                    <div class="tpsearch">
                    	平仓时间：<select id="ostaus" class="span7" name="ostaus">
                    				<option value="">默认不选</option>
                ...
                <div class="span10 pull-right" style="margin-top: 20px;">
                    <input type="submit" class="btn-flat info" value="开始查找">
            ...
            <div class="row-fluid table">
                    ...
                    <tbody id="ajaxback">
                    	<?php if(is_array($orders)): $i = 0; $__LIST__ = $orders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="first <?php if($vo["ostaus"] == 0): ?>create<?php else: endif; ?>">
		                        ...
		                        <td>
		                           		...
		                           		<?php echo (date('Y-m-d H:i:m',$vo["buytime"])); ?>
		                        </td>
		                         <td>
		                            	<?php echo (date('Y-m-d H:i:m',$vo["selltime"])); ?>
                ...
                <div class="qjcz">
					今日盈亏统计：&nbsp;&nbsp;买涨手数：<font color="#f00" size="4"><?php echo ($sum['zhang']); ?></font>手&nbsp;&nbsp;交易额统计：<font color="#f00" size="5"><?php echo ($sum['die']); ?></font>手<br/>
					默认显示30秒内要平仓的订单。
				</div>
            </div>
