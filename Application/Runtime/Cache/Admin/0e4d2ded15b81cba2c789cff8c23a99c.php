        ...
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span8 column">
					...
					<div class="field-box" style="width: 45%;">
						<label>点差x：</label>
						<input class="span2" type="text" data-toggle="tooltip" data-trigger="focus" title="点差x" data-placement="right" value="<?php echo ($editgood['patx']); ?>"/>
					</div>
					<div class="field-box" style="width: 50%;">
						<label>点差-：</label>
						<input class="span2" type="text" data-toggle="tooltip" data-trigger="focus" title="点差-" data-placement="right" value="<?php echo ($editgood['patj']); ?>"/>
					</div>
...
<!--平仓弹出层开始 -->
<form action="<?php echo U('Goods/pingcangcl');?>" method="post">
<div class="modal fade" id="myModal<?=$i?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<input type="hidden" name="wave" value="<?php echo ($editgood['wave']); ?>">
			<input type="hidden" name="qishu" value="<?php echo ($i+1); ?>">
            </div>
