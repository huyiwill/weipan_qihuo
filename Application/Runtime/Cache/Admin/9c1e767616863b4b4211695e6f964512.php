    ...
    <div class="container-fluid">
    	<div id="pad-wrapper" class="users-list">
            ...
            <div class="row-fluid header head2">
                    ...
                    <a href="<?php echo U('Goods/gtypeadd');?>" class="btn-flat success">
                        <span>&#43;</span>
                        添加分类
                    </a>
            </div> 
            ...
            <!---type list---->
	            ...
	            <table class="table table-hover">
                    ...
                    <tbody id="ajaxback">
                    <?php if(is_array($typelist)): $i = 0; $__LIST__ = $typelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gl): $mod = ($i % 2 );++$i;?><!-- row -->
                    <tr class="first">
						<td>
                        ...
                        <td>
							<ul class="actions">
								<li style="border: 0;"><a href="<?php echo U('Goods/gtedit',array('cid'=>$gl['cid']));?>"><i class="table-edit"></i></a></li>
								<li class="last"><a href="<?php echo U('Goods/gtdel',array('cid'=>$gl['cid']));?>" onclick="if(confirm('确定要删除吗?')){return true;}else{return false;}"><i class="table-delete"></i></a></li>
							</ul>
                        </td>
