    ...
    <div class="container-fluid">
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
                <form action="<?php echo U('Coupons/cpsend');?>" method="post">
                    <!-- left column -->
                    <div class="span8 column">
                        ...
                        <div class="field-box">
                            ...
                            <select name="cptype" style="width:250px" class="select2">
                                ...
                                <?php if(is_array($cpall)): $i = 0; $__LIST__ = $cpall;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cp): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cp['eid']); ?>"/><?php echo ($cp['eprice']); ?>元,有效期<?php echo ($cp['limittime']); ?>天<?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                        <!--<div class="field-box">
                            <label>分发用户:</label>
                            <select style="width:250px" multiple="" class="select2">
                                ...
                                <?php if(is_array($ulist)): $i = 0; $__LIST__ = $ulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ult): $mod = ($i % 2 );++$i;?><option value="<?php echo ($ult['uid']); ?>"/><?php echo ($ult['username']); endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>-->
                        <div class="field-box">
                            <label>分发用户:</label>
                            <select name="cpuname" style="width:250px"  class="select2">
                                <option value="all"/>全部用户
                                <?php if(is_array($ulist)): $i = 0; $__LIST__ = $ulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ult): $mod = ($i % 2 );++$i;?><option value="<?php echo ($ult['uid']); ?>"/><?php echo ($ult['username']); endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
