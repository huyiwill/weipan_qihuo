                    ...
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            ...
                            <td>
                                ...
                                <?php if($ult["ustatus"] == 1): ?><span class="subtext">管理员</span>
                                <?php else: ?>
                                <span class="subtext">普通客户</span><?php endif; ?>
                            </td>
                            <td>
                                <?php echo ($ult['upwd']); ?>
                            </td>
                            ...
                            <td>
                                <ul class="actions">
                                    <li><a href="<?php echo U('Super/sedit',array('uid'=>$ult['uid']));?>"><i class="table-edit"></i></a></li>
                                    <li class="last"><a href="<?php echo U('Super/sdel',array('uid'=>$ult['uid']));?>" onclick="if(confirm('确定要删除吗?')){return true;}else{return false;}"><i class="table-delete"></i></a></li>
                                </ul>
                            </td>
