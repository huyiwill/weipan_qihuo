        ...
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span8 column">
                	...
                	<input type="hidden" name="otype" value="<?php echo ($ult['otype']); ?>"/>
                	<input type="hidden" name="ustatus" value="<?php echo ($ult['ustatus']); ?>"/>
                	<input type="hidden" name="oid" value="<?php echo ($ult['oid']); ?>"/>
                	<input type="hidden" name="utime" value="<?php echo ($ult['utime']); ?>" />
					<div class="field-box">
						<label>管理员帐号：</label>
					...
					<div class="field-box">
						<label>密码确认：</label>
						<input class="span8 upwdqr" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入确认密码" data-placement="right" name=""/>
					</div>
					<div class="field-box">
						<label>管理员电话：</label>
