    ...
    <div class="container-fluid">
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
            	<form action="<?php echo U('Coupons/cpadd');?>" method="post">
                <!-- left column -->
                <div class="span8 column">
                	<input type="hidden" name="getstyle" value="0"/>
					<div class="field-box">
						<label>优惠卷价格：</label>
						<input class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入优惠卷金额" data-placement="right" name="eprice"/>
					</div>
					<!--<div class="field-box">
                        <label>分发用户:</label>
					...
					<div class="field-box">
                        <label>有效期:</label>
                        <input type="text" value="" name="limittime"/>天
                    </div>
					<!--<div class="field-box">
                        <label>结束时间:</label>
