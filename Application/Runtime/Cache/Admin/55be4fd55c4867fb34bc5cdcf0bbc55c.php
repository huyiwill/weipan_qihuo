        ...
        <div id="pad-wrapper" class="users-list">
            ...
            <script type="text/javascript">
        		...
        		if(dqurl.indexOf("oldlist")>0){
        			...
        			document.writeln("<div class='row-fluid header head2'><a href=\"<?php echo U('Coupons/cpadd');?>\" class=\"btn-flat success\">添加优惠卷</a></div>");
        		}
        	</script>
            <!-- Users table -->
            ...
            <div class="row-fluid table">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($coulist)): $i = 0; $__LIST__ = $coulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cl): $mod = ($i % 2 );++$i;?><!-- row -->
                    <tr class="first">
						<td>
							<input type="checkbox" name="eid[]" value="<?php echo ($cl['eid']); ?>">
                            <?php echo ($cl['eid']); ?>
                        </td>
                        <!--<td>
                        	<?php if($cl['coustyle'] == 1): ?><span class="label">已过期</span>
                        	<?php else: ?>
							<span class="label label-info">进行中</span><?php endif; ?>
                        </td>-->
                        <td>
                            ￥<?php echo ($cl['eprice']); ?>
                        </td>
                        <td>
                            <?php echo ($cl['limittime']); ?>天
                        </td>
                       <!-- <td>
                            <?php echo (date('Y-m-d',$cl['endtime'])); ?>
                        </td>-->
                        <td>
							<a href="<?php echo U('Coupons/exlist',array('eid'=>$cl['eid']));?>">查看</a>
                        </td>
                        <td>
							<ul class="actions">
								<!--<li><a href="<?php echo U('Coupons/cpedit',array('eid'=>$cl['eid']));?>"><i class="table-edit"></i></a></li>
								<li><i class="table-settings"></i></li>-->
								<li class="last"><a href="<?php echo U('Coupons/cpdel',array('eid'=>$cl['eid']));?>" onclick="if(confirm('确定要删除吗?')){return true;}else{return false;}"><i class="table-delete"></i></a></li>
							</ul>
                        </td>
