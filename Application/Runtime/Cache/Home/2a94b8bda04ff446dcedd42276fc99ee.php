  ...
  <div class="wrap" style="overflow:scroll;overflow-x:hidden;">
    <div class="index" style="min-height: 1339px;">
            ...
            <?php if(is_array($nolist)): $i = 0; $__LIST__ = $nolist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$on): $mod = ($i % 2 );++$i;?><!-- 油 -->
              <?php if($on["cid"] == 1): ?><tr class="ykzf openpay">
                  ...
                  <td class="buyprice"><?php echo ($on["buyprice"]); ?>
                    <?php if($on["ostyle"] == 1): ?><font color="#2fb44e">(空)</font>
                      <?php else: ?>
                      <font color="#ed0000">(多)</font><?php endif; ?>
                  </td>
                  ...
                  <td class="mypwd-btn chr">
                    ...
                    <a href="<?php echo U('Detailed/orderid');?>?orderid=<?php echo ($on["oid"]); ?>" class="red" data-cid='<?php echo ($on["cid"]); ?>'
                       data-oid='<?php echo ($on["oid"]); ?>'>平仓</a>
                    <a href="javascript:void(0);" class="blue" data-onumber='<?php echo ($on["onumber"]); ?>' data-oid='<?php echo ($on["oid"]); ?>'
                       data-zy='<?php echo ($on["endprofit"]); ?>' data-zk='<?php echo ($on["endloss"]); ?>'>设置</a>
      ...
      <div class="account-info clearfix">
        ...
        <?php if($user["portrait"] == ''): else: ?>
          style="background:url(<?php echo ($user["portrait"]); ?>)no-repeat;background-size: 40px 40px;"<?php endif; ?>
        >
        <a href="<?php echo U('User/memberinfo');?>"> <span class="a-u">个人账户(元)</span> <em class="a-d ">
          <?php if($user["price"] != 0): ?><span id="usprice"><?php echo ($user["price"]); ?></span>
            <?php else: ?>
            <span id="usprice">0.0</span><?php endif; ?>
        </em></a></div>
      <a href="<?php echo U('User/recharge');?>" class="charge-btn
      ">充值</a>
      <div class="info-detail right"><a href="<?php echo U('User/experiencelist');?>"> <span class="a-u">体验劵(张)</span> <em
        class="a-d">
        <?php if($user["exper"] != 0): echo ($user["exper"]); ?>
          <?php else: ?>
          0<?php endif; ?>
      </em> </a></div>
    </div>
    ...
    <div style="width:100%;height:235px;overflow:hidden;">
      <div class="switch-product">
        <ul class="clearfix" id="nav_li">
          <?php if(is_array($catgood)): $i = 0; $__LIST__ = $catgood;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i;?><li onclick="click_li(<?php echo ($cat["cid"]); ?>)" value="<?php echo ($cat["cid"]); ?>"><?php echo ($cat["cname"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
      </div>

      <div id="content-wrpper">
        <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i;?><div class="product-box" value="<?php echo ($cat["cat"]["cid"]); ?>" id="content-wrpper<?php echo ($cat["cat"]["cid"]); ?>">
            <!--***油***-->
            <div class="trade-box">
              <div class="price-info clearfix">
                <h3 class="price-current"><span style="font-size: 1rem;"><?php echo ($cat["cat"]["cname"]); ?>价格(元/吨)</span>
                  <?php if($isopen == 0): ?><em>休市</em>
                    <?php else: ?>
                    <em class="" id="youjia"><?php echo ($cat["cat"]["ask"]); ?></em><?php endif; ?>

                </h3>
                <ul class="price-trend clearfix">
                  <li>昨收<em id="yzs"><?php echo ($cat["cat"]["close"]); ?></em></li>
                  <li>最高<em id="yzg"><?php echo ($cat["cat"]["high"]); ?></em></li>
                  <li>今开<em id="yjk"><?php echo ($cat["cat"]["open"]); ?></em></li>
                  <li>最低<em id="yzd"><?php echo ($cat["cat"]["low"]); ?></em></li>
                </ul>
              </div>
              ...
              <div class="swiper-container   swiper3">
                <div class="swiper-wrapper"
                    ...
                    <?php foreach($cat as $k => $vo){?>
                    <?php if(is_numeric($k) === true): ?><div class="swiper-slide swiper-slide-visible swiper-slide-active" data-l="6" data-b="2"
                        ...
                        <img src="/Public/Home/images/pick.png" class="p-selected">
                      </div><?php endif; ?>
                  <?php } ?>
                </div>
              </div>
        ...
        <div class="pop-box none" id="buildBox" style="display: block;top:-350px">
          ...
          <form id="jcForm" class="build-form" method="post" action="<?php echo U('Detailed/addorder');?>">
            ...
            <div class="b-line clearfix">
              ...
              <p class="b-info">手续费&nbsp;<span id="j-5">0</span>&nbsp;元&nbsp;<img src="/Public/Home/images/qrgm.png"
            ...
            <a href="<?php echo U('Index/index');?>" class="pwd-btn chr failure  none" style="display: none;"
    ...
    <div class="info-box">
      ...
      <div class="info-d none">
        <ul class="news-list clearfix">
          <?php if(is_array($focus)): $i = 0; $__LIST__ = $focus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('News/newsid');?>?nid=<?php echo ($vo['nid']); ?>" class="clearfix"> <span><?php echo ($vo["ntitle"]); ?></span> <i><?php echo (date('Y-m-d
              H:i:s',$vo["ntime"])); ?></i> </a></li><?php endforeach; endif; else: echo "" ;endif; ?>
          <a href="<?php echo U('News/newslist');?>?fid=2" class="news-more">查看更多&gt;</a>
        </ul>
      </div>
      <div class="info-d none">
        <ul class="news-list clearfix">
          <?php if(is_array($notices)): $i = 0; $__LIST__ = $notices;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('News/newsid');?>?nid=<?php echo ($vo['nid']); ?>" class="clearfix"> <span><?php echo ($vo["ntitle"]); ?></span> <i><?php echo (date('Y-m-d
              H:i:s',$vo["ntime"])); ?></i> </a></li><?php endforeach; endif; else: echo "" ;endif; ?>
